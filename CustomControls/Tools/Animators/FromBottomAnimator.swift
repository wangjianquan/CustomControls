...
//        let roundedCornerView = UIView(frame: UIEdgeInsetsInsetRect(presentationWrapperView.bounds, UIEdgeInsets(top: 0, left: 0, bottom: -corner_radius, right: 0)))
        ...
        let roundedCornerView = UIView(frame: presentationWrapperView.bounds.inset(by: UIEdgeInsets(top: 0, left: 0, bottom: -corner_radius, right: 0)))
        ...
        roundedCornerView.autoresizingMask = UIView.AutoresizingMask.flexibleHeight
            ...
            /**/
         let presentedWrapperView = UIView(frame: roundedCornerView.bounds.inset(by: UIEdgeInsets(top: 0, left: 0, bottom: corner_radius, right: 0)))
        
        presentedViewControllerView?.autoresizingMask = UIView.AutoresizingMask.flexibleHeight
...
//       do {
        ...
        dismmingView.autoresizingMask = UIView.AutoresizingMask.flexibleHeight
        //添加手势
